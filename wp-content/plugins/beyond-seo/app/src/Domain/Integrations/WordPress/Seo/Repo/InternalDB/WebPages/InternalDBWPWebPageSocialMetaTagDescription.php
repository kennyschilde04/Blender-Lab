...
/**
 * Class InternalDBWPWebPageSocialMetaTagDescription
 * @method WPWebPageSocialDescriptionMetaTag find(DoctrineQueryBuilder|string|int $idOrQueryBuilder, bool $useEntityRegistryCache = false, ?InternalDBMetaTagModel &$loadedOrmInstance = null, bool $deferredCaching = false, array $initiatorClasses = [] )
...
class InternalDBWPWebPageSocialMetaTagDescription extends InternalDBEntity {
	public const BASE_ENTITY_CLASS = WPWebPageSocialDescriptionMetaTag::class;
     ...
     *
     * @return WPWebPageSocialDescriptionMetaTag|null
    ...
    ): ?WPWebPageSocialDescriptionMetaTag {
        return $this->getMetaTagByTypeAndId($initiatingEntity->postId, WPWebPageMetaTag::TAG_TYPE_SOCIAL_DESCRIPTION, $lazyloadAttributeInstance->useCache);
    }
     ...
     * @throws ReflectionException
     */
	public function mapToEntity( bool $useEntityRegistryCache = false ): ?WPWebPageSocialDescriptionMetaTag
	{
        /** @var WPWebPageSocialDescriptionMetaTag $entity */
		$entity = parent::mapToEntity( $useEntityRegistryCache );

        $entity->id = $this->ormInstance->id;
        $entity->postId = $this->ormInstance->post_id;
        $entity->type = $this->ormInstance->type ?? WPWebPageMetaTag::TAG_TYPE_SOCIAL_DESCRIPTION;
	...
	protected function mapToRepository(Entity &$entity): bool
	{
		...
		$ormInstance->type = $entity->type ?? WPWebPageMetaTag::TAG_TYPE_SOCIAL_DESCRIPTION;
     ...
     * @param bool $useCache
     * @return WPWebPageSocialDescriptionMetaTag|null The WPWebPageMetaTag entity.
     * @throws BadRequestException
     * @throws InternalErrorException
     * @throws InvalidArgumentException
     * @throws ReflectionException
     ...
     * @throws MappingException
     */
	public function getMetaTagByTypeAndId(int $postId, string $type, bool $useCache = false): ?WPWebPageSocialDescriptionMetaTag
    {
