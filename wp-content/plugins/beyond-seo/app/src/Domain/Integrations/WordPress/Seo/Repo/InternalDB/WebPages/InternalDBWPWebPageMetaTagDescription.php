...
/**
 * Class InternalDBWPWebPageMetaTagDescription
 * @method WPWebPageDescriptionMetaTag find(DoctrineQueryBuilder|string|int $idOrQueryBuilder, bool $useEntityRegistryCache = false, ?InternalDBMetaTagModel &$loadedOrmInstance = null, bool $deferredCaching = false, array $initiatorClasses = [] )
...
class InternalDBWPWebPageMetaTagDescription extends InternalDBEntity {
	public const BASE_ENTITY_CLASS = WPWebPageDescriptionMetaTag::class;
     ...
     *
     * @return WPWebPageDescriptionMetaTag|null
    ...
    public function lazyload(
        ...
        return $this->getMetaTagByTypeAndId($initiatingEntity->postId, WPWebPageMetaTag::TAG_TYPE_DESCRIPTION, $lazyloadAttributeInstance->useCache);
    }
     ...
     * @throws ReflectionException
     */
	public function mapToEntity( bool $useEntityRegistryCache = false ): ?WPWebPageDescriptionMetaTag
	{
        /** @var WPWebPageDescriptionMetaTag $entity */
		$entity = parent::mapToEntity( $useEntityRegistryCache );

        $entity->id = $this->ormInstance->id;
        $entity->postId = $this->ormInstance->post_id;
        $entity->type = $this->ormInstance->type ?? WPWebPageMetaTag::TAG_TYPE_DESCRIPTION;
	...
	protected function mapToRepository(Entity &$entity): bool
	{
		...
		$ormInstance->type = $entity->type ?? WPWebPageMetaTag::TAG_TYPE_DESCRIPTION;
     ...
     * @param bool $useCache
     * @return WPWebPageDescriptionMetaTag|null The WPWebPageMetaTag entity.
     * @throws BadRequestException
     * @throws InternalErrorException
     * @throws InvalidArgumentException
     * @throws ReflectionException
     ...
     * @throws MappingException
     */
	public function getMetaTagByTypeAndId(int $postId, string $type, bool $useCache = false): ?WPWebPageDescriptionMetaTag
    {
