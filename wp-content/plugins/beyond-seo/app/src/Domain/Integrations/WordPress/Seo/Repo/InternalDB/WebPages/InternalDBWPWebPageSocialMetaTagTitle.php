...
/**
 * Class InternalDBWPWebPageSocialMetaTagTitle
 * @method WPWebPageSocialTitleMetaTag find(DoctrineQueryBuilder|string|int $idOrQueryBuilder, bool $useEntityRegistryCache = false, ?InternalDBMetaTagModel &$loadedOrmInstance = null, bool $deferredCaching = false, array $initiatorClasses = [] )
...
class InternalDBWPWebPageSocialMetaTagTitle extends InternalDBEntity {
	public const BASE_ENTITY_CLASS = WPWebPageSocialTitleMetaTag::class;
     ...
     *
     * @return WPWebPageSocialTitleMetaTag|null
    ...
    ): ?WPWebPageSocialTitleMetaTag {
        return $this->getMetaTagByTypeAndId($initiatingEntity->postId, WPWebPageMetaTag::TAG_TYPE_SOCIAL_TITLE, $lazyloadAttributeInstance->useCache);
    }
     ...
     * @throws ReflectionException
     */
	public function mapToEntity( bool $useEntityRegistryCache = false ): ?WPWebPageSocialTitleMetaTag
	{
        /** @var WPWebPageSocialTitleMetaTag $entity */
		$entity = parent::mapToEntity( $useEntityRegistryCache );

        $entity->id = $this->ormInstance->id;
        $entity->postId = $this->ormInstance->post_id;
        $entity->type = $this->ormInstance->type ?? WPWebPageTitle::TAG_TYPE_SOCIAL_TITLE;
	...
	protected function mapToRepository(Entity &$entity): bool
	{
		...
		$ormInstance->type = $entity->type ?? WPWebPageMetaTag::TAG_TYPE_SOCIAL_TITLE;
     ...
     * @param bool $useCache
     * @return WPWebPageSocialTitleMetaTag|null The WPWebPageMetaTag entity.
     * @throws BadRequestException
     * @throws InternalErrorException
     * @throws InvalidArgumentException
     * @throws ReflectionException
     ...
     * @throws MappingException
     */
	public function getMetaTagByTypeAndId(int $postId, string $type, bool $useCache = false): ?WPWebPageSocialTitleMetaTag
    {
