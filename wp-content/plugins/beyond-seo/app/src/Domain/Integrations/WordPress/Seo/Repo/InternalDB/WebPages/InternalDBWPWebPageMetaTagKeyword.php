...
/**
 * Class InternalDBWPWebPageMetaTagKeyword
 * @method WPWebPageKeywordsMetaTag find(DoctrineQueryBuilder|string|int $idOrQueryBuilder, bool $useEntityRegistryCache = false, ?InternalDBMetaTagModel &$loadedOrmInstance = null, bool $deferredCaching = false, array $initiatorClasses = [] )
...
class InternalDBWPWebPageMetaTagKeyword extends InternalDBEntity {
	public const BASE_ENTITY_CLASS = WPWebPageKeywordsMetaTag::class;
     ...
     *
     * @return WPWebPageKeywordsMetaTag|null
    ...
    ): ?WPWebPageKeywordsMetaTag {
        return $this->getMetaTagByTypeAndId($initiatingEntity->postId, WPWebPageMetaTag::TAG_TYPE_KEYWORDS, $lazyloadAttributeInstance->useCache);
    }
     ...
     * @throws ReflectionException
     */
	public function mapToEntity( bool $useEntityRegistryCache = false ): ?WPWebPageKeywordsMetaTag
	{
        /** @var WPWebPageKeywordsMetaTag $entity */
		$entity = parent::mapToEntity( $useEntityRegistryCache );

        $entity->id = $this->ormInstance->id;
        $entity->postId = $this->ormInstance->post_id;
        $entity->type = $this->ormInstance->type ?? WPWebPageMetaTag::TAG_TYPE_KEYWORDS;
	...
	protected function mapToRepository(Entity &$entity): bool
	{
		...
		$ormInstance->type = $entity->type ?? WPWebPageMetaTag::TAG_TYPE_KEYWORDS;
     ...
     * @param bool $useCache
     * @return WPWebPageKeywordsMetaTag|null The WPWebPageMetaTag entity.
     * @throws BadRequestException
     * @throws InternalErrorException
     * @throws InvalidArgumentException
     * @throws ReflectionException
     ...
     * @throws MappingException
     */
	public function getMetaTagByTypeAndId(int $postId, string $type, bool $useCache = false): ?WPWebPageKeywordsMetaTag
    {
