...
class RCWebPageTitleMetaTags extends WPWebPageTitleMetaTag
{
    use RCTrait;
    use RCSecurityTrait;

    /**
     * Get the endpoint for loading the title meta tags
     *
     * @return string|null
     */
    ...
    /**
     * @param WPWebPageTitleMetaTag $parent
