...
class RCLoadingParameters
{
     ...
     * @return void
     */
    public static function create(string $classNameToBeLoaded, mixed ...$loadingParameters): RCLoadingParameters{
        return new RCLoadingParameters($classNameToBeLoaded, ...$loadingParameters);
    }
}