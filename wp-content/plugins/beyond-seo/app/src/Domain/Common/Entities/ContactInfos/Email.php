...
class Email extends ContactInfo
{
    ...
    /**
     * @return Domain|null Returns Domain component of Email
     */
    public function getDomain(): ?Domain
    {
        ...
        $domainString = substr($this->value, strpos($this->value, '@') + 1);
