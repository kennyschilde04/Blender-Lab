...
/**
 * Menu class
 * Provides a unified way to add multiple submenu items for a toplevel menu point
 */
class Menu {
	/**
	...
	public static function remove_unwanted_submenu_item() {
		remove_submenu_page( self::get_slug(), self::get_slug() );
	}

	/**
	 * Adds the toplevel menu page
	 */
	 ...
	 *
	 * @return string Returns the AuthorName or 'IONOS' if it’s empty.
	 */
...
add_action( 'admin_menu', [ Menu::class, 'remove_unwanted_submenu_item' ], 999 );
