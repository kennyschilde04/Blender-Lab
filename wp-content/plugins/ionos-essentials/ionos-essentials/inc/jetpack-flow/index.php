...
\add_action('init', function (): void {
  if (isset($_SERVER['SCRIPT_NAME']) && strpos(wp_login_url(), $_SERVER['SCRIPT_NAME']) !== false) {
    \add_filter(
  ...
  if (_is_plugin_active(JETPACK_PLUGIN_FILE)) {
    if (strpos($_SERVER['REQUEST_URI'], 'page=ionos-assistant&setup_action=partner&usecase=jetpack-backup&coupon=') !== false) {
